...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    // 转换成html a 链接
    public static String change2HtmlA(String value) {
        if(isBlank(value)) {
            return "";
        }
        String [] files = subFile(value);
        ...
        for(String one : files) {
            ...
            sb.append(one.substring(one.lastIndexOf("/")+1));
            sb.append("</a>");
            sb.append("  ");
        }
    ...
    // 截取每张文件地址
    public static String [] subFile(String value) {
        if(isBlank(value)) {
            return null;
        }
    ...
    //主副表形式，副表文件修改时，截取路径地址
    public static String  detailSubFile(String value) {
    ...
    public static String jsDecodeURI(String str) {
